"""Score exported human verdicts against the pipeline annotations.

    python report_verdicts.py path/to/review_verdicts.json

Reports accuracy per axis (boundary / label / sentence / episode coherence),
label accuracy per action verb, and flag calibration: do review-queue flags
actually predict human-found errors?
"""
...
def main():
    ...
    ap.add_argument("verdicts", help="review_verdicts.json exported from the UI")
