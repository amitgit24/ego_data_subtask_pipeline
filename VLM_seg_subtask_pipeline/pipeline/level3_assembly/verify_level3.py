...
re-check, annotated preview videos, summary report. Identical in spirit to
Kinematics_pipeline's verify_level3.py.
...
def main():
    ...
    checks = [
        ...
        (f"{min(args.previews, len(valid))} preview videos rendered for human review", True),
    ]
    print("\n================ LEVEL 3 VERIFIER ================")
    all_pass = True
